export const GENRE_CATEGORIES = [
  {
    ...
    genres: [
      ...
      { name: '史诗奇幻', desc: '西方剑与魔法，巨龙怒吼与骑士信仰', icon: '🐉' },
  ...
  },
  {
    ...
    genres: [
      ...
      { name: '秦汉三国', desc: '群雄逐鹿，逐鹿中原，铁血权谋', icon: '🏯' },
      { name: '两宋元明', desc: '山河破碎，文人骨气，保家卫国', icon: '🎋' },
      { name: '特种兵王', desc: '最强利刃，铁血军魂，保家卫国', icon: '🎖️' },
      { name: '战争幻想', desc: '虚构现代战争，海陆空全面争霸', icon: '🛡️' }
    ]
  },
  {
    id: 'kehuan',
  ...
  },
  {
    ...
    icon: '🔍',
    genres: [
      { name: '诡秘神秘', desc: '克苏鲁神话，深渊污染，精神崩溃边缘', icon: '👁️' },
      { name: '规则怪谈', desc: '致命法则，异常管理局，遵守规则求生', icon: '📋' },
      { name: '探险寻宝', desc: '摸金校尉，古墓影院，失落遗迹', icon: '🗺️' },
      { name: '侦探推理', desc: '侧写追凶，密室杀人，纯粹逻辑博弈', icon: '🕵️' },
      { name: '灵异民俗', desc: '中式恐怖，纸人抬轿，民俗禁忌', icon: '👻' }
    ]
  },
  {
    id: 'youxi',
...
export const TONES = [
  ...
  { name: '无限流恐怖', desc: '规则生存，悬念丛生，穿梭于诸天恐怖任务', icon: '💀' }
];
