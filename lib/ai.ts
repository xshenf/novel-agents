...
沈砚微笑着颔首，黑眸深邃，仿佛能将陆青禾整个人看穿，却只是默默陪她喝着茶，任由窗外雷声大作，屋内的暗流不断奔涌……`;
  ...
  generateKernelSettings(projectTitle: string, genre: string, tone: string): any {
    ...
    const templates: Record<string, any> = {
      '仙侠武侠': {
        worldSetting: [
          { name: "灵气枯竭的末法时代", description: "天道规则异变、灵力每日枯竭。高阶修士封锁洞府苟延残喘，甚至掠夺低阶修士灵力，修行界环境极其严酷。" },
          { name: "九重天界与凡界", description: "世界分为九重天。下界修士建立的万仙盟共同打理凡界，而上三重天则是真仙道统，俯瞰并奴役下界。" },
          { name: "太古神魔遗留的破碎荒原", description: "大地由死去的太古巨兽和陨落神魔残骸构成，荒野中弥漫法则风暴，只有神火照耀的神殿庇护所里才能安全繁衍。" }
        ],
        powerSystem: [
        ...
        skillSystem: [
          { name: "五行功法体系", description: "功法按金木水火土五行分类，每行分凡阶、灵阶、仙阶三等。修士主修一行辅修一行，五行相生相克决定战斗克制关系。" },
          { name: "剑道独尊体系", description: "天下功法万般，唯剑道至高。剑道分为：剑气、剑意、剑域、剑心、剑道法则。修剑者一剑可破万法，但修炼难度极高。" },
          { name: "神通符箓体系", description: "功法以符箓为载体，分为攻击符、防御符、辅助符三大类。高阶修士可凝符成阵，以天地为纸绘制万道神通。" }
        ],
        location: [
          { name: "东荒三域与禁地", description: "东荒分为天枢域、天璇域、天玑域，各域间有上古禁地阻隔。核心场景：万仙盟圣地、深渊裂谷、太古遗迹、仙葬之地。" },
          { name: "九重天界", description: "下三重天为凡界大陆，中三重天为仙人居所，上三重天为太古神域。每重天之间有天门相隔，需渡劫方可飞升。" },
          { name: "破碎星域", description: "太古大战后世界碎裂为无数星域，星域间以古传送阵连接。核心场景：祖星、荒芜星域、深渊魔渊、永恒神殿。" }
        ],
        faction: [
          { name: "东荒三宗、西漠佛国、北海妖域", description: "天玄大陆地理庞大。东荒由三大长生仙宗统治，西漠由大雷音寺及佛国掌控信仰，北海则是无尽妖族统领。各方犬牙交错，摩擦不断。" },
          { name: "九重天界与凡界仙盟", description: "世界分为九重天。下界由修士建立的万仙盟共同打理，而上三重天则是高高在上的真仙道统，俯瞰并奴役下界凡人修士。" },
          { name: "诸天万界与不朽古族", description: "三千大世界，万界争锋。古老的不朽世家占据了资源最丰厚的祖星，建立跨越星域的星际传送阵，压榨边缘弱小生命世界。" }
        ],
        currency: [
          { name: "灵石体系", description: "下品灵石、中品灵石、上品灵石、极品灵石，百进一。灵石既是修炼资源也是通用货币，高阶灵石可辅助突破瓶颈。" },
          { name: "功德点体系", description: "斩妖除魔、济世度人可积累功德点，功德点可在天道商城兑换功法、丹药、法器。杀人越货则扣除功德，遭天谴。" },
          { name: "道韵碎片体系", description: "天地间散落的法则碎片，蕴含大道之力。道韵碎片可融入功法提升品阶，也可在修士间交易，是比灵石更稀缺的硬通货。" }
        ],
        item: [
          { name: "太古神器与仙器", description: "太古大战遗留的神器碎片散落人间，每件都有独特神通。仙器需以修士精血认主，可随主人修为成长而觉醒更多能力。" },
          { name: "天地奇物与造化灵宝", description: "天地孕育的奇物如：混沌石、造化青莲、轮回镜。灵宝有灵智，择主而栖，得之者可逆天改命。" },
          { name: "符箓法宝与阵法核心", description: "修士以灵材炼制的法宝，分为凡器、灵器、宝器、仙器。阵法核心可布设护山大阵、困敌杀阵，是宗门立足之本。" }
        ],
        outlineFull: [
...
export const ai = {
  ...
  async generateKernelSettings(projectTitle: string, genre: string, tone: string, apiKey?: string, modelName?: string): Promise<any> {
    const systemInstruction = `你是一个专业的顶级网络小说总策划和架构师。你的任务是根据给定的书名、题材和文风，推演这部网络小说的全部核心设定维度，每个维度提供恰好 3 套风格迥异、极具网文爽点与创意的备选方案。

维度清单（共 10 个）：
1. worldSetting - 世界观设定：小说主舞台的大陆疆域、宏观规则、历史背景与社会法则
2. coreConflict - 核心冲突：推动主线发展的主要矛盾，主角面临的终极敌对势力或危机
3. sellingPoints - 爽点卖点：网文吸引读者的商业爽点，如打脸、越级挑战、幕后黑手等节奏设计
4. powerSystem - 力量体系：修炼境界、超自然等级与晋升逻辑
5. skillSystem - 功法体系：核心功法、武技、法术的分类与层级
6. goldFinger - 金手指：主角的特殊外挂、系统、随身宝物或独占机缘
7. location - 地理地图：核心地域、重要场景与地理格局
8. faction - 势力阵营：主要势力、宗门、组织及其关系
9. currency - 货币体系：世界中的交易媒介、资源体系与价值尺度
10. item - 关键物品：推动剧情的重要道具、神器、宝物

请以 JSON 格式输出，格式如下：
{
  "worldSetting": [
    {"name": "方案A名称", "description": "方案A世界观描述"},
    {"name": "方案B名称", "description": "方案B世界观描述"},
    {"name": "方案C名称", "description": "方案C世界观描述"}
  ],
  "coreConflict": [...],
  "sellingPoints": [...],
  "powerSystem": [...],
...
题材是：${genre}
文风是：${tone}
请根据以上信息推演出这 10 个维度的 3 套高品质备选设定方案，务必符合当前题材且具备商业网文的流行爽感。`;
