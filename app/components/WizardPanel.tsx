...
// ── Sub-component: Step 1 - Genre Selection ──
function WizardStepGenre({
  selectedGenreCategory, setSelectedGenreCategory,
  selectedGenre, setSelectedGenre,
  customGenreInput, setCustomGenreInput,
}: {
  selectedGenreCategory: string;
  setSelectedGenreCategory: (v: string) => void;
  selectedGenre: string;
  setSelectedGenre: (v: string) => void;
  customGenreInput: string;
  setCustomGenreInput: (v: string) => void;
}) {
  return (
    <div>
...
// ── Sub-component: Step 2 - Tone Selection ──
function WizardStepTone({
  ...
  setCustomToneInput: (v: string) => void;
}) {
  return (
    <div>
...
// ── Sub-component: Step 3 - Tags Selection ──
function WizardStepTags({
...
// ── Sub-component: Right-side Preview Card ──
          ...
          {wizardLoading ? (
            ...
            <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                {wizardStep === 1 && (
                  <WizardStepGenre
                    selectedGenreCategory={selectedGenreCategory}
                    setSelectedGenreCategory={setSelectedGenreCategory}
                    selectedGenre={selectedGenre}
                    setSelectedGenre={setSelectedGenre}
                    customGenreInput={customGenreInput}
                    setCustomGenreInput={setCustomGenreInput}
                  />
                )}
