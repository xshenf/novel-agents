...
import { Save, Loader2, Eye, Edit3, Plus, Trash2, ArrowUp, ArrowDown, User, Activity, Key, BookOpen, Check, X, Tag, Lock, Unlock, Sparkles, Compass, Flame, Zap, Award, Trophy, CheckCircle2, ChevronUp, ChevronDown } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: '1', minHeight: 0, position: 'relative' }}>
      ...
      <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 0 }}>
        ...
        {/* 四级 Tab 控制组：核心设定、分卷大纲、章节细纲、故事资产 */}
        ...
        {outlineSubTab === 'kernel' ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', minHeight: 0, flexGrow: 1 }}>
            ...
            {/* 7 大维度卡片列表 */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto', paddingRight: '4px', flexGrow: 1 }}>
              <KernelDimensionCard
